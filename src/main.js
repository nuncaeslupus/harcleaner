new Vue({
  ...
  methods: {
    ...
    saveFile: function () {
      ...
      const filename =
        dotloc > -1
          ? `${f.substr(0, dotloc)}_cleaned${f.substr(dotloc)}`
          : `${f}_cleaned.har`;
